...
export default function App() {
  const [expenses, setExpenses] = useState([
    { id: createId(), title: "Food", amount: 30, category: "Food" },
    { id: createId(), title: "Taxi", amount: 48, category: "Transport" },
    { id: createId(), title: "Clothes", amount: 102, category: "Shopping" },
    { id: createId(), title: "Data", amount: 56, category: "Bills" },
  ]);
  ...
  const CATEGORIES = ["Food", "Transport", "Bills", "Shopping", "University","Other"];
